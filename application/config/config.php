...
|
*/
$explode_arr = explode('/index.php', $_SERVER['PHP_SELF']);

$base_url = $_SERVER['HTTP_HOST'].$explode_arr[0];
$config['base_url']	= 'http://'.$base_url;
$config['assets_url']	= 'http://'.$base_url.'/assets';
$config['uploads_url']	= 'http://'.$base_url.'/uploads';
