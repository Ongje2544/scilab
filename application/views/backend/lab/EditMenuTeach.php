                    ...
                    <div class="card-body" style="background-color: rgb(245, 245, 245);">
                        <form role="form" id="editTeach" enctype="multipart/form-data" action="<?PHP echo config_item("base_url"); ?>/lab/updateTeach" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="Teach" class="form-control col-sm-10" id="MoreTeacher" placeholder="กรอกเพิ่มชื่ออาจารย์/ครูผู้สอน" value="<?php echo $row->Teach_name ?>">
                            </div>
                            <div class="form-group">
                                <label for="MoreTeacher">เบอร์ติดต่ออาจารย์/ครูผู้สอน (ถ้ามี)</label>
                                <input type="text" name="Teach_callnum" class="form-control col-sm-10" id="callNumber2" placeholder="กรอกเพิ่มชื่ออาจารย์/ครูผู้สอน" value="<?php echo $row->Teach_callnum ?>">
                            </div>
