        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="<?PHP echo config_item("base_url"); ?>/branch/restoreMenuBranc">การกู้ข้อมูลหมวดหมู่</a></li>
            ...
            <div class="col-6">
                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                        <a href="<?PHP echo config_item("base_url"); ?>/branch/restoreMenuBranch/" class="btn btn-default">กลับ</a>
                        <form role="form" id="insertLablist" enctype="multipart/form-data" action="<?PHP echo config_item("base_url"); ?>/branch/RestoreBranch" method="post">
                        ...
                        <form role="form" id="insertLablist" enctype="multipart/form-data" action="<?PHP echo config_item("base_url"); ?>/branch/SuredeleteBranch" method="post">
                            <input name="inputID" type="hidden" value="<?php echo $row->Branch_id ?>">
