    ...
    $(document).ready(function() {
        ...
        $("#btBranch").click(function(event) {
            ...
            if (txt_error) {
                ...
                $("#editBranch").off('submit').submit(); // ยกเลิก event.preventDefault() ชั่วคราวเพื่อส่ง form
            }
        });
    });
</script>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
				...
				<div class="card card-info">
                    ...
                    <form role="form" id="editBranch" enctype="multipart/form-data" action="<?PHP echo config_item("base_url"); ?>/branch/updateBranch" method="post">
                    <?php if (isset($_GET['Success'])) { ?>
						...
						<div class="card-body" style="background-color: rgb(245, 245, 245);">
							<div class="form-group mt-3 mr-5 d-flex">
                                ...
                                <input type="text" name="Branch" class="form-control col-sm-8" id="MoreBranch" placeholder="กรอกเพิ่มหมวดหมู่รายวิชา" value="<?php echo $row->Branch_name ?>">
							</div>
						</div>
